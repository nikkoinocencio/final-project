...
var timesPlay = prompt ("How many times would you like to play?");
function rollDice() {
...
function whoWon() {
    ...
    if (timesPlay <= 0){
      prompt ("Thanks For Playing! Insert Credit Card Information Here.");
    }

    // Report the outcome:
    banner = die1 + " + " + die2 + " is: " + dieSum;
    document.querySelector("h3").innerHTML = banner + "<br>" + outcome;
    document.querySelector("h4").innerHTML = "Balance: $" + balance;
    document.querySelector("h5").innerHTML = "Rolls Left: " + timesPlay;
}
